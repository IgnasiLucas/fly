...
full rank [@Lagrange2012, p. 138], and therefore it is not invertible. I suspect
...
important question is how many principal components we should use in the RDA. It would
be tempting to use as many as possible to make sure that any correlation signal is still
...
It seems reasonable to assume that the number of correlated sigas is small, even
...
RDA0 <- rda(LH.imp.1[, interesting] ~ 1 + Condition(batch),
